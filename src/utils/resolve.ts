...
export async  function resolveENSOrReturnAddress(input: string): Promise<string> {
    try {
      ...
      if (ethers.utils.isAddress(input)) {
        ...
        const ens = new ethers.Contract('0x0cc23341aacFc90B1582d965943d1f10D94638Cf',ensAbi, provider);
