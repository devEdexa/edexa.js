...
class StableCoin {
    ...
    getContractInstance() {
        let contract = new ethers_1.ethers.Contract(this.address, StableCoin_json_1.default, this.provider);
        return contract;
    }
    // Create a contract instance for actions (requires a signer)
    getActionContractInstance(signer) {
        let contract = new ethers_1.ethers.Contract(this.address, StableCoin_json_1.default, signer);
        return contract;
    }
    // Read functions
    /**
     ...
     */
    addToBlacklist(_account, signer) {
        return __awaiter(this, void 0, void 0, function* () {
            _account = yield (0, resolve_1.resolveENSOrReturnAddress)(_account);
            let contract = this.getActionContractInstance(signer);
            let res = yield contract.addToBlacklist(_account);
            return res.toString();
        });
    }
    /**
     ...
     * @returns {Promise<any>} The transaction result.
     */
    removeFromBlacklist(_account, signer) {
        return __awaiter(this, void 0, void 0, function* () {
            _account = yield (0, resolve_1.resolveENSOrReturnAddress)(_account);
            let contract = this.getActionContractInstance(signer);
            let res = yield contract.removeFromBlacklist(_account);
            return res.toString();
        });
    }
}
exports.StableCoin = StableCoin;
//# sourceMappingURL=StableCoinClass.js.map